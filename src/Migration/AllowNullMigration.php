...
namespace MetaModels\AttributeAliasBundle\Migration;
...
class AllowNullMigration extends AbstractMigration
{
    ...
    {
        return 'Allow null values in MetaModels "alias" attributes.';
    }
    ...
    private function fixColumn(string $tableName, string $columnName): void
    {
        $this->connection->query(
            sprintf('ALTER TABLE %1$s AS t CHANGE t.%2$s t.%2$s varchar(255) NULL', $tableName, $columnName)
        );
    }
}
