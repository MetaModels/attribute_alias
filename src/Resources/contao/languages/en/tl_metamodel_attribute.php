...
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['validAliasCharacters'][0] = 'Valid alias characters';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['validAliasCharacters'][1] =
    'Here you can select a custom character set for auto-generated aliases.';
