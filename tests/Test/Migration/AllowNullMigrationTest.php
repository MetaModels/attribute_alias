...
namespace MetaModels\AttributeAliasBundle\Test\Migration;
...
/**
 * @covers \MetaModels\AttributeAliasBundle\Migration\AllowNullMigration
 */
class AllowNullMigrationTest extends TestCase
{
    public function testName(): void
    {
        ...
        self::assertSame('Allow null values in MetaModels "alias" attributes.', $migration->getName());
    }
